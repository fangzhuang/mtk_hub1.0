...
void pedometer_forcing_time_out();

float get_pedometer_step_freq();
uint8_t get_pedometer_smd_event();
uint8_t get_pedometer_step_detector();
uint32_t get_pedometer_step_count();
pedometer_stat_t get_pedometer_status();
uint32_t step_count_for_floor_counting();
#endif